            ...
            <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
                <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
                    <img
                        ...
                        src={post.author?.photo?.url || '/default-author-image.png'} // Provide a default author image URL
                    />
                    <p className='inline align-middle text-grey-700 ml-2 text-lg'>{post.author?.name || 'Unknown Author'}</p>
                </div>
